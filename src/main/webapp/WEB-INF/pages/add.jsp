...
<body>
<form action="crud/users" method="post">
    <div style="padding: 100px 0 0 250px;">
        <div id="login-box">
            <h2><%=LangBundle.bundle.getString("user")%></h2>
            <br>
            <br>
            ...
            <div id="login-box-field" style="margin-top:20px;">
                <input name="password" class="form-login" title="password" value="" size="30" maxlength="50" />
            </div>
            <br />
...
<form action="crud/items" method="post">
    <div style="padding: 100px 0 0 250px;">
        <div id="login-box">
            <h2><%=LangBundle.bundle.getString("item")%></h2>
            <br>
            <br>
            <div id="login-box-name" style="margin-top:20px;"><%=LangBundle.bundle.getString("name")%></div>
            <div id="login-box-field" style="margin-top:20px;">
