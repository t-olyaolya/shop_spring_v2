...
<head>
    ...
    <title><%=LangBundle.bundle.getString("reg")%></title>
...
<form action="reg" method="get">
    <div style="padding: 100px 0 0 250px;">
        <div id="login-box">
            <h2><%=LangBundle.bundle.getString("reg")%></h2>
            <br>
            <br>
            ...
            <br />
            <input style="margin-left:100px;" type="submit" value=<%=LangBundle.bundle.getString("reg")%> />
        </div>
    </div>
</form>
</body>
